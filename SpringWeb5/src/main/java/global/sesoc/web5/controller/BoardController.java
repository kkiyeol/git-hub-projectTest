...
public class BoardController {
	...
	public String write(
		...
		logger.debug("파일정보 : {}", upload.getContentType());
		logger.debug("파일정보 : {}", upload.getName());
		logger.debug("파일정보 : {}", upload.getOriginalFilename());
		logger.debug("파일정보 : {}", upload.getSize());
		logger.debug("파일정보 : {}", upload.isEmpty());
